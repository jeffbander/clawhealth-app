...
/* Lucide-style 16px stroke icons — consistent weight, clean lines */
      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            `}
          >
            <span className={`w-4 flex items-center justify-center flex-shrink-0 ${isActive ? "text-gray-700" : "text-gray-400"}`}>
              {ICONS[link.icon] ?? <span>·</span>}
            </span>
